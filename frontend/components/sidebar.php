...
<aside id="sidebar" aria-hidden="true"
    class="fixed left-0 top-0 z-[60] h-dvh lg:h-screen w-[75vw] max-w-[320px] lg:w-64 bg-linear-to-b from-slate-800 to-slate-900 flex flex-col shadow-2xl transition-transform duration-300 ease-out transform -translate-x-full lg:translate-x-0 print:hidden"
    aria-label="Sidebar">
    <!-- Logo & Brand Section -->
    <div class="p-4 border-b border-white/10 flex flex-col shrink-0">
        <div class="flex items-center justify-between">
            <div class="flex items-center gap-3 overflow-hidden">
                ...
                <div
                    class="sidebar-logo w-12 h-12 lg:w-12 lg:h-12 rounded-full bg-white overflow-hidden flex items-center justify-center shadow-lg shrink-0 transition-all duration-300">
                    <img src="<?php echo htmlspecialchars(getImagePath('frontend/images/ch-logo.png')); ?>"
                        alt="City Health Office Logo"
                        class="w-full h-full object-contain rounded-full transition-all duration-300">
                </div>
            ...
            <button id="sidebarCloseMobile"
                class="shrink-0 p-2 hover:bg-white/10 rounded-lg transition-colors cursor-pointer lg:hidden"
                title="Close Sidebar">
            ...
            <button id="sidebarToggleDesktop"
                class="shrink-0 p-1.5 hover:bg-white/10 rounded-lg transition-colors cursor-pointer hidden lg:flex"
        ...
        <div id="sidebarToggleCollapsedWrapper"
            class="w-full justify-center items-center transition-all duration-300 ease-in-out hidden mt-3">
            <button id="sidebarToggleCollapsed"
                class="shrink-0 p-1.5 hover:bg-white/10 rounded-lg transition-colors cursor-pointer relative group"
                title="Expand Sidebar">
                <svg id="sidebarToggleIconCollapsed" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                    stroke-width="2" stroke="currentColor" class="w-5 h-5 text-white transition-transform duration-200">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M8.25 4.5l7.5 7.5-7.5 7.5" />
                </svg>
                <span
                    class="tooltip absolute left-full ml-2 px-2 py-1 bg-slate-900 text-white text-xs rounded whitespace-nowrap opacity-0 pointer-events-none transition-opacity duration-200 z-50">Expand
                    Sidebar</span>
            </button>
        </div>
    </div>
        ...
        <ul class="space-y-1">
            ...
            <li id="adminNavItem" class="hidden">
                <a href="../admin/" data-tooltip="User Management"
                    ...
                    <span class="sidebar-text text-sm whitespace-nowrap flex-1 text-left nav-text">Admin</span>
                </a>
            </li>
            ...
            <li>
                <button type="button" data-tooltip="Annual Budget Summary"
                    ...
                    <span class="sidebar-text text-sm whitespace-nowrap flex-1 text-left nav-text">Annual Budget
                        Summary</span>
                ...
                <div id="budget-dropdown"
                    ...
                    <a href="../specialfund/" data-tooltip="Special Program Fund"
                        class="nav-item nav-subitem flex items-center gap-2.5 px-3 py-2 ml-6 rounded-lg text-white/70 hover:text-white hover:bg-white/10 active:bg-white/20 transition-all cursor-pointer touch-manipulation">
                        <svg class="w-4 h-4 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <li>
                ...
                <div id="expenses-dropdown"
                    ...
                    <a href="../monthly-expenses/" data-tooltip="Monthly Expenses Summary"
                        ...
                        <svg class="w-4 h-4 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                d="M4 18V9m4 9V5m4 14v-7m4 7v-3"></path>
                        </svg>
                        <span class="sidebar-text text-sm whitespace-nowrap nav-text">Monthly Expenses Summary</span>
                    </a>
                    <a href="../itemized/" data-tooltip="Itemized Daily Transactions"
                        class="nav-item nav-subitem flex items-center gap-2.5 px-3 py-2 ml-6 rounded-lg text-white/70 hover:text-white hover:bg-white/10 active:bg-white/20 transition-all cursor-pointer touch-manipulation">
                        <svg class="w-4 h-4 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                d="M8 6h13M8 12h13M8 18h13M3 6h.01M3 12h.01M3 18h.01"></path>
                        </svg>
                        <span class="sidebar-text text-sm whitespace-nowrap nav-text">Itemized Daily Transactions</span>
                    </a>
                    <a href="../specialfund/" data-tooltip="Special Program Fund"
                        class="nav-item nav-subitem flex items-center gap-2.5 px-3 py-2 ml-6 rounded-lg text-white/70 hover:text-white hover:bg-white/10 active:bg-white/20 transition-all cursor-pointer touch-manipulation">
                        <svg class="w-4 h-4 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <span class="sidebar-text text-sm whitespace-nowrap nav-text">Special Program</span>
                    </a>
                </div>
            </li>
        ...
        <ul class="space-y-1">
            ...
            <li>
                <a href="../../../" data-tooltip="Logout"
                    class="nav-item nav-link flex items-center gap-2.5 px-3 py-2.5 rounded-lg text-white/80 hover:text-white hover:bg-red-600/20 active:bg-red-600/30 transition-all group relative w-full cursor-pointer touch-manipulation">
                    <svg class="w-5 h-5 shrink-0 transition-all duration-200" aria-hidden="true"
                        xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
                        <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
