...
<aside id="sidebar" aria-hidden="true" class="fixed left-0 top-0 z-[60] h-dvh lg:h-screen w-[75vw] max-w-[320px] lg:w-64 bg-linear-to-b from-slate-800 to-slate-900 flex flex-col shadow-2xl transition-transform duration-300 ease-out transform -translate-x-full lg:translate-x-0" aria-label="Sidebar">
        ...
        <div class="flex items-center justify-between">
            <div class="flex items-center gap-3 overflow-hidden">
                ...
                <div class="sidebar-logo w-12 h-12 lg:w-12 lg:h-12 rounded-full bg-white overflow-hidden flex items-center justify-center shadow-lg shrink-0 transition-all duration-300">
                    <img src="<?php echo htmlspecialchars(getImagePath('frontend/images/ch-logo.png')); ?>" alt="City Health Office Logo" class="w-full h-full object-contain rounded-full transition-all duration-300">
                </div>
    ...
    <nav class="flex-1 min-h-0 px-3 pt-3 pb-4 space-y-1 overflow-y-auto overflow-x-hidden">
        <ul class="space-y-1">
            ...
            <li id="adminNavItem" class="hidden">
                <a href="../admin/" data-tooltip="User Management" class="nav-item nav-link flex items-center gap-2.5 px-3 py-2.5 rounded-lg text-white/80 hover:text-white hover:bg-white/10 active:bg-white/20 transition-all group relative w-full cursor-pointer touch-manipulation">
                    <svg class="w-5 h-5 shrink-0 transition-all duration-200" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
                        <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z"></path>
                    </svg>
    ...
    <div class="sidebar-footer-section border-t border-white/10 pt-3 mt-auto shrink-0 px-3 pb-[calc(env(safe-area-inset-bottom)+0.75rem)]">
        <ul class="space-y-1">
            ...
            <!-- Logout -->
            <li>
                <a href="../../../" data-tooltip="Logout" class="nav-item nav-link flex items-center gap-2.5 px-3 py-2.5 rounded-lg text-white/80 hover:text-white hover:bg-red-600/20 active:bg-red-600/30 transition-all group relative w-full cursor-pointer touch-manipulation">
                    <svg class="w-5 h-5 shrink-0 transition-all duration-200" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
