            ...
            <header class="flex items-center justify-between bg-white border-b border-slate-200 px-4 py-3">
                ...
                <div class="relative">
                    ...
                    <div id="userDropdown" class="hidden absolute right-0 mt-2 w-48 rounded-lg bg-white shadow-lg border border-slate-100 py-2 z-50">
                        ...
                        <a id="settingsBtn" href="../settings/" class="block px-4 py-2 text-sm text-slate-700 hover:bg-slate-50 cursor-pointer transition rounded-lg">
                            <div class="flex items-center space-x-2">
                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <section class="mb-6">
                    <div class="bg-white border border-slate-200 rounded-xl shadow-sm p-4 md:p-6">
                        ...
                        <p class="text-sm md:text-base text-slate-600">
                            This view displays the City Health Office&apos;s Special Program Fund actual expenses against the approved budget for
                            <span id="specialFundCurrentYearInline" class="font-semibold text-slate-900"></span>.
                            It highlights remaining funds in pesos and percentage to help you quickly identify program performance across various health initiatives.
                        </p>
                    </div>
                </section>
                        ...
                        <div class="flex flex-col md:flex-row gap-4 md:items-center md:justify-between md:flex-wrap">
                            ...
                            <div class="flex flex-col sm:flex-row gap-3 md:gap-4 md:items-center sm:flex-wrap">
                                ...
                                <div class="flex items-center gap-3">
                                    ...
                                    >
                                        <svg id="specialFundSortDirectionIcon" class="h-5 w-5" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <section>
                    <div class="bg-white border border-slate-200 rounded-xl shadow-sm overflow-hidden">
                        <div class="overflow-x-auto">
                            <table id="specialFundTable" class="min-w-full divide-y divide-slate-200 text-sm">
                                ...
                                <tbody id="specialFundTableBody" class="divide-y divide-slate-100 bg-white">
                                    <!-- Rows rendered by specialfund.js -->
                                </tbody>
                            </table>
                        </div>
                        ...
                        <div class="flex flex-col gap-3 border-t border-slate-200 px-4 py-3 md:flex-row md:items-center md:justify-between">
                            <p class="text-xs md:text-sm text-slate-600" id="specialFundPaginationSummary">
                                Showing 0 to 0 of 0 entries
                            </p>
                            <div class="flex items-center justify-end gap-2">
                                <button
                                    id="specialFundPrevPage"
                                    type="button"
                                ...
                                <div id="specialFundPageNumbers" class="flex items-center gap-1 text-sm md:text-xs">
                                    <!-- Page buttons rendered by specialfund.js -->
                                </div>
                                <button
                                    id="specialFundNextPage"
                                    type="button"
                                    class="inline-flex items-center justify-center rounded-lg border border-slate-300 bg-white px-3 py-2 text-sm font-medium text-slate-700 hover:bg-slate-100 disabled:cursor-not-allowed disabled:opacity-60 cursor-pointer transition-colors md:px-2 md:py-1 md:text-xs"
                                >
                                    Next
